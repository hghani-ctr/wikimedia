...
def main():
    ...
    chart.plot_line('month', '%_of_new_articles_about_gender_minorities', 
                    wmf_colors['blue'])
    
    plt.scatter(df['month'], df['%_of_new_articles_about_gender_minorities'], 
    ...
    chart.annotate(x='month',
            y='%_of_new_articles_about_gender_minorities',
            use_last_y=True,
            perc = True)
